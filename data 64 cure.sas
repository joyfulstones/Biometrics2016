...
libname data64 "c:\liulei\paper\paper11\data64";

%let datadir=c:\liulei\paper\paper11\data64;
data data64.est1_all;
set _null_;
run;
data data64.fit1_all;
set _null_;
run;

data data64.theta1_all;
set _null_;
run;
data data64.est2_all;
set _null_;
run;
data data64.fit2_all;
set _null_;
run;
data data64.theta2_all;
set _null_;
run;

data data64.est3_all;
set _null_;
run;
data data64.fit3_all;
set _null_;
run;
data data64.theta3_all;
set _null_;
run;
...
data data64.est2_all;
set data64.est2_all est2;
run;

data data64.fit2_all;
set data64.fit2_all fit2;
run;


data data64.est3_all;
set data64.est3_all est3;
run;

data data64.fit3_all;
set data64.fit3_all fit3;
run;
...
data _null_;
set result;
file "c:\liulei\paper\paper11\data64\AGQresult1.txt";
...
data _null_;
set result;
file "c:\liulei\paper\paper11\data64\AGQresult2.txt";
...
data _null_;
set result;
file "c:\liulei\paper\paper11\data64\fitstat.txt";
